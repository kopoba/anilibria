<?php
require('/var/www/html/private/MaxMind-GeoIP2/geoip2.phar');
$maxmind = new GeoIp2\Database\Reader('/var/www/html/private/MaxMind-GeoIP2/maxmind-db/GeoLite2-Country.mmdb');
