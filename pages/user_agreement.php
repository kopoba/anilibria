...
$var['title'] = 'Пользовательское соглашение';
$var['page'] = 'user_agreement';
...
<div class="news-block">
    <div class="news-body">
        ...
        <div class="day">О сайте</div>
        <p>Интернет - ресурс (сайт) AniLibria.tv (в дальнейшем - Ресурс) является интернет-сайтом любительских переводов/озвучек, где пользователи могут предоставить свой перевод и озвучку аниме, получая возможность загружать, смотерть и делится ею с другими пользователями проекта. Любой желающий может подать заявку на озвучку и/или перевод.</p>
        <div class="day">1. О пользовательском соглашении</div>
        <p>Используя/посещая Ресурс (включая весь контент, размещенный на ресурсе), вы соглашаетесь с Настоящим пользовательским соглашением, размещенным по адресу https://www.anilibria.tv/pages/user_agreement.php. Если вы не согласны с любым из пунктов данного Пользовательского соглашения, пожалуста, покиньте ресурс. Пользовательское соглашение может быть изменено Администрацией без какого-либо уведомления пользователей. Новая версия ПС вступает в силу по истечении 3 (трех) дней с момента ее размещения, если иное не предусмотрено новой редакцией Ппользовательского соглашения.</p>
        <div class="day">2. Условия ограничения ответственности</div>
        ...
        <p>- за содержание материалов, полученных Пользователем в результате использования данных с Ресурса, их возможное несоответствие действующему законодательству или оскорбительный характер;</p>
        <p>- за последствия применения, использования или неиспользования полученной информации;</p>
        <p>- за возможное несоответствие результатов, полученных при использовании Ресурса, ожиданиям Пользователя;</p>
        <p>- за какие-либо повреждения оборудования или программного обеспечения Пользователя, возникшие в результате использовании Ресурса;</p>
        <p>- за отсутствие возможности использования Ресурса по каким-либо причинам;</p>
        ...
        <div class="day">3. Ограничение на использование ресурса пользователем</div>
        <p>При использовании данного Ресурса, ПОЛЬЗОВАТЕЛЬ не имеет права, и соглашается с этим:</p>
        <p>- размещать файлы или программы, предназначенные для нарушения, уничтожения либо ограничения функциональности любого компьютерного или телекоммуникационного оборудования или программ, для осуществления несанкционированного доступа, а также серийные номера к коммерческим программным продуктам и программы для их генерации, логины, пароли и прочие средства для получения несанкционированного доступа к платным ресурсам в Интернете, а также размещать ссылки на вышеуказанную информацию;</p>
        <p>- размещать контент затрагивающий какой-либо патент, торговую марку, коммерческую тайну, копирайт или прочие права собственности и/или авторские и смежные с ним права третьих лиц;</p>
        <p>- отправлять на адреса электронной почты, указанные на сайте, несанкционированные почтовые сообщения рекламного типа (junk mail, spam);</p>
        <p>- копировать и использовать в коммерческих целях любую информацию, получаемую посредством данного ресурса, нарушающую права других Пользователей или могущую нанести им прямой материальный или моральный ущерб;</p>
        <p>- размещать ссылки на ресурсы Сети, содержание которых противоречит действующему законодательству РФ;</p>
        <p>- размещать материалы, содержащие взрослый контент; неприемлемым считается следующее содержание:</p>
        <p>&nbsp; - изображения и видео с полностью обнаженными людьми или сексуальными сценами;</p>
        <p>&nbsp; - непристойные или провокационные изображения;</p>
        <p>&nbsp; - эротические рассказы, откровенные тексты;</p>
        <p>&nbsp;  - сексуальные советы или рекомендации;</p>
        <p>- выдавать себя за другого человека или за представителя организации и/или сообщества без достаточных на то прав, в том числе за сотрудников Aдминистрации, за владельца Ресурса.</p>
        <div class="day">4. Гарантирование работоспособности</div>
        ...
        <div class="day">5. Права администрации ресурса</div>
        ...
        <div class="day">6. Ответственность сторон</div>
        <p>Пользователь соглашается с тем, что все возможные споры по поводу Соглашение об использовании будут разрешаться по нормам российского права.</p>
        ...
        <div class="day">7. Согласие с пользовательским соглашением</div>
